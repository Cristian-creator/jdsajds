...
$hamburger-size: 25px !default;
$hamburger-thickness: 2px !default;
$hamburger-color: #006456 !default;
$hamburger-color-hover: white !default;
$hamburger-color-active: #006456 !default;
...
$hamburger-background-transition-speed: 0.1s !default;
...
$hamburger-animation-speed: 2 !default;
